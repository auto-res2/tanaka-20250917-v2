...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/reliability_full_CoVeR_SPO.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/reliability_no_isotonic.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/reliability_no_conformal.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{images/reliability_no_both.pdf}
